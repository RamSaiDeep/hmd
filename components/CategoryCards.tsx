...
const categories = [
  ...
  { label: "SRDRS Recording Studio", icon: "🎙️", href: "/category/srdrs", color: "from-purple-600/30" },
  { label: "Hostel Programs", icon: "🏠", href: "/category/hostel-programs", color: "from-emerald-600/30" },
];
    ...
    <section id="services" className="bg-slate-100 px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="mb-12 text-center">
          ...
          <p className="text-lg text-slate-600">Pick a service area to continue: Music Programs, SRDRS Recording Studio, or Hostel Programs.</p>
        </div>
